...
// Locally-trusted cert (see `mkcert` in ../.cert/, shared with backend/) so
// getUserMedia (mic access) works when this dev server is opened from
// another device on the LAN — browsers only allow it over HTTPS or localhost.
